package com.example.coroutineassignement
...
import com.example.coroutineassignement.ui.theme.CoRoutineAssignementTheme
    ...
    fun bankProcess(account: Account): Saldos {
        ...
        withTimeMeasurement("Two $N times deposit coroutines together", isActive = true) {
            runBlocking {
                ...
                job1.join() // Wait for first coroutine to finish
                job2.join() // Wait for second coroutine to finish
